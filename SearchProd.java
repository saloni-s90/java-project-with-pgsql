...
public class SearchProd extends JFrame implements ActionListener
{
	JButton b1,b2,b3;
	JLabel l1,l2;
	JTextField t1;
	...
	{		
		...
		l2 = new JLabel("SEARCH PRODUCT",JLabel.CENTER);
		l2.setBounds(10,10,400,70);
		add(l2);
		l2.setFont(f3);

		l1 = new JLabel("Product no",JLabel.CENTER);
		...
		add(t1);
		t1.setToolTipText("Enter vaild Product no");
