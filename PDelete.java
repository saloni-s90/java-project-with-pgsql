...
public class PDelete extends JFrame implements ActionListener 
{
	...
	PDelete()
	{
		...
		l1 = new JLabel("DELETE RECORDS OF PRODUCT",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		try
		{
			...
			if(b3==b1)
			{
				...
				sql1 = "select * from product where pno = "+t1.getText()+";";
				...
				while(rs.next())
				{
					...
					{
						st = cn.createStatement();
						sql = "delete from product where pno ="+t1.getText()+";";
