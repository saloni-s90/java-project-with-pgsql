...
public class UpdateEmp extends JFrame implements ActionListener
{
	...
	UpdateEmp()
	{
		...
		setTitle("   UPDATE EMPLOYEE MOBILE   ");
		setLocation(50,50);
		...
		l1 = new JLabel("  UPDATE EMPLOYEE MOBILE ",JLabel.CENTER);
		...
		l4 = new JLabel("NEW MOBILE",JLabel.CENTER);
		...
		l5 = new JLabel("CONFIRM MOBILE",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			if(b4==b2)
			{
				...
				String sql = "select * from employee where id = '"+t1.getText()+"';";
				rs = st.executeQuery(sql);
				while(rs.next())
				{
					if(t3.getText().equals(t4.getText()))
					{
						sql1 = "update employee set mobile = '"+t3.getText()+"'  where id= '"+t1.getText()+"';"; 
