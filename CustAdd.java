...
public class CustAdd extends JFrame implements ActionListener
{
	...
	CustAdd()
	{
		...
		i1 = new JLabel("ADD CUSTOMER DETAIL ",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(b3 == b1)
		{
			try
			{
				...
				String q = "insert into customer values("+a+",'"+b+"','"+c+"','"+d+"','"+e+"','"+f+"');";
				st.executeUpdate(q);
