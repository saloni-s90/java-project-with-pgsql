...
import javax.swing.*;
import java.sql.*;
public class SearchEmp extends JFrame implements ActionListener
{
	JButton b1,b2,b3;
	JLabel l1,l2;
	JTextField t1;
	...
	{		
		...
		l2 = new JLabel("SEARCH EMPLOYEE",JLabel.CENTER);
		l2.setBounds(10,10,400,70);
		add(l2);
		l2.setFont(f3);

		l1 = new JLabel("Employee ID",JLabel.CENTER);
...
//		System.out.println("connection set");
		b3 = (JButton)ae.getSource();
			if(b3==b1)	
			{
				...
				while(rs.next())
				{
					if((t1.getText().compareTo(rs.getString(1))==0))
						new EPrint(t1.getText());
//					else
